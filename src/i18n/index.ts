...
const homeEnglishToChinese: readonly Replacement[] = [
  ['Generate and Prepare Visual Assets', '生成与处理视觉素材'],
  ['Generate placeholders and palettes, prepare images locally, and ship production-ready visual assets to people, code, and AI agents.', '生成占位图与配色，在本地处理图片，并向用户、代码和 AI 智能体交付可直接使用的视觉素材。'],
  ...
  ['Generate and prepare visual assets.', '生成与处理视觉素材。'],
  ['Create placeholders and color systems, or prepare real images locally. Every result is ready to use.', '生成占位图与色彩系统，或在本地处理真实图片。每份结果都可直接使用。'],
  ['Choose how to begin', '选择开始方式'],
  ['>Generate</strong>', '>生成</strong>'],
  ['>Prepare</strong>', '>处理</strong>'],
  ['One result, every path.', '一份结果，多种路径。'],
  ['Create a production-ready SVG, then move directly into the tool you need. No account and no upload required.', '先生成可直接使用的 SVG，再进入所需工具。无需账户，也无需上传。'],
  ...
  ['Start with a new visual or color system.', '从新的视觉素材或色彩系统开始。'],
  ['Finish real images privately in your browser.', '在浏览器中私密处理真实图片。'],
  ...
  ['Use the same output everywhere.', '在每处使用同一份输出。'],
  ['Copy one deterministic URL into code, or give an agent the exact API contract behind it.', '将固定 URL 复制到代码中，或把对应的精确 API 契约交给智能体。'],
  ['A short rule keeps placeholder output consistent across coding tools.', '一条简短规则，让不同编码工具生成一致的占位图输出。'],
  ['Developer resources', '开发者资源'],
  ['Choose the format that fits your workflow.', '选择适合当前工作流的格式。'],
  ...
  ['Shape the visual, then copy the exact output you need.', '调整视觉效果，再复制所需的精确输出。'],
  ['Color tasks', '色彩工具'],
